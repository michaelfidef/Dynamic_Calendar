    ...
    if ($_POST){
        ...
        if($id_event == null){
            ...
            if(isset($_FILES)){
                ...
                $sql = "UPDATE isi set keterangan = \"$keterangan\" , tgl_mulai = \"$tglMulai\" , tgl_selesai = \"$tglSelesai\", wkt_mulai = \"$wktMulai\" , wkt_selesai = \"$wktSelesai\", level_Kepentingan = \"$levelKepentingan\" , gambar_kegiatan = \"$uploadGambar\",lokasi = \"$lokasi\" where id = \"$id_event\"";
